...
<template>
    <div :class="currentView === 'welcome' ? 'h-screen relative bg-cover bg-center' : 'h-screen relative'" :style="currentView === 'welcome' ? { backgroundImage: `url(http://localhost:3000/uploads/background-image.png)` } : {}">
            ...
            <div class="w-full max-w-6xl">
                <div class="flex justify-between mb-6">
                    <div class="bg-white text-gray-900 p-6 rounded-lg shadow-md w-1/2 mr-3 border-2 border-black">
                        ...
                        <p>Marzysz o przejażdżce sportowym samochodem...</p>
                    </div>
                    <div class="bg-white text-gray-900 p-6 rounded-lg shadow-md w-1/2 ml-3 border-2 border-black">
                        ...
                        <p>Odkryj luksus w najlepszym wydaniu...</p>
                    </div>
                </div>
                <div class="bg-white text-gray-900 p-6 rounded-lg shadow-md border-2 border-black">
                    ...
                    <p>Twoja pasja do szybkich samochodów jest teraz na wyciągnięcie ręki...</p>
                </div>
            </div>
        </div>
        ...
        <div v-else-if="currentView === 'user'" class="container">
            ...
            <div class="mb-5 p-4 border rounded bg-gray-100">
                <h3 class="text-xl font-semibold mb-3">Filtruj i sortuj samochody</h3>
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <input v-model="filters.model"
                           ...
                           class="border p-2 rounded" />
                    <select v-model="filters.year" class="border p-2 rounded">
                ...
                <div class="mt-4">
                    <label class="block font-semibold mb-2">Sortuj według:</label>
                    <select v-model="sortOrder" class="border p-2 rounded">
                        ...
                        <option value="horsepower-asc">Moc (rosnąco)</option>
                        <option value="horsepower-desc">Moc (malejąco)</option>
                    </select>
                </div>
            </div>

            <!-- Lista samochodów -->
            <div v-for="car in filteredCars" :key="car._id" class="border p-3 mb-2 rounded shadow">
        ...
        <div v-else-if="currentView === 'admin'" class="container">
            ...
            <!-- Lista samochodów -->
            <div v-for="car in filteredCars" :key="car._id" class="border p-3 my-2 rounded shadow">
                <p>{{ car.brand }} {{ car.model }} ({{ car.year }}, {{ car.horsepower }} KM)</p>
